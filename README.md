...
[![GitHub Repo stars](https://img.shields.io/github/stars/ditto-404/outlook-mcp?style=social)](https://github.com/ditto-404/outlook-mcp)
...
```bash
git clone https://github.com/ditto-404/outlook-mcp.git
cd outlook-mcp
```
